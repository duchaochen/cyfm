...
public class RepositoryHelper {
    ...
    public static EntityManager getEntityManager() {
        Assert.notNull(entityManager, "entityManager must null, please see " +
                "[RepositoryHelper#setEntityManagerFactory]");
    ...
    /**
     * <p>ql条件查询<br/>
     * searchCallback默认实现请参考 {@see DefaultSearchCallback}<br/>
     * <p/>
     * 测试用例请参考：{@see com.ppcxy.common.studenttest.repository.StudentRepositoryImplForCustomSearchIT}
     * 和{@see com.ppcxy.common.studenttest.repository.RepositoryImplForDefaultSearchIT}
     *
     * @param ql
    ...
    /**
     * <p>按条件统计<br/>
     * 测试用例请参考：{@see com.ppcxy.common.studenttest.repository.StduentRepositoryImplForCustomSearchIT}
     * 和{@see com.ppcxy.common.studenttest.repositoryRepositoryImplForDefaultSearchIT}
     *
     * @param ql
     * @param searchable
     ...
     * 具体使用请参考测试用例：{@see com.ppcxy.common.studenttest.repository.StudentRepositoryImplIT#testFindAll()}
     *
     * @param ql
     ...
     * 具体使用请参考测试用例：{@see com.ppcxy.common.studenttest.repository.StudentRepositoryImplIT#testFindOne()}
     *
     * @param ql
     * @param params
     * @param <M>
     ...
     * 具体使用请参考测试用例：com.ppcxy.common.studenttest.repository.StudentRepositoryImplIT#testCountAll()
     *
     * @param ql
     * @param params
     * @return
     ...
     * 具体使用请参考测试用例：{@see com.ppcxy.common.studenttest.repository.StudentRepositoryImplIT#testBatchUpdate()}
     *
     * @param ql
     * @param params
     * @return
