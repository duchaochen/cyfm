 ...
 * <p>Version: 1.0
 */
public class ObjectSerializeUserType4Clob implements UserType, Serializable {
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SessionImplementor session, Object owner) throws HibernateException, SQLException {
        ...
        try {
            Clob hexClob = rs.getClob(names[0]);
            ois = new ObjectInputStream(new ByteArrayInputStream(Hex.decodeHex(clobToString(hexClob).toCharArray())));
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index, SessionImplementor session) throws HibernateException, SQLException {
        ...
        if (value == null) {
            ...
            try {
                ...
                //clob.setString(0, hexStr);
                
                Reader clobReader = new StringReader(hexStr);
                st.setCharacterStream(index, clobReader);
            } catch (Exception e) {
                throw new HibernateException(e);
            } finally {
                try {
