...
public class LogUtils {
    ...
    public static final Logger ERROR_LOG = LoggerFactory.getLogger("cy-error");
    public static final Logger ACCESS_LOG = LoggerFactory.getLogger("cy-access");
    ...
    protected static String getUsername() {
        return ShiroUserInfoUtils.getUsername();
    }
