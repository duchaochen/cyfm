package com.ppcxy.common.utils.html;

import com.ppcxy.common.utils.jsoup.HtmlCleaner;
import com.ppcxy.common.utils.jsoup.HtmlWhitelist;
...
public class HtmlUtils {
    ...
    public static String text(String html) {
        ...
        return Jsoup.parse(removeUnSafeTag(html).replaceAll("&lt;", "<").replaceAll("&gt;", ">")).text();
    }
