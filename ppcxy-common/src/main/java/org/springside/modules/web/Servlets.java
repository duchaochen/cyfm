...
public class Servlets {
     ...
     * @return
     */
    public static void changeCookie(String cookieName, String newValue,HttpServletRequest request,HttpServletResponse response) {
    ...
    public static void addCookie(String cookieName, String value, HttpServletResponse response) {
        addCookie(new Cookie(cookieName, value), response);
    }
     ...
     * @param response
     */
    public static void addCookie(String cookieName, String value, Integer maxAge, HttpServletResponse response) {
     ...
     * @return
     */
    public static Cookie removeCookie(String cookieName, HttpServletRequest request) {
        Cookie[] cookies = request.getCookies();
        if (cookies != null) {
            for (Cookie cookie : cookies) {
                if (cookieName.equals(cookie.getName())) {
