 ...
 * <p>测试查询条件</p>
 */
public class SearchStudentRepository2WithRepository2ImpIT extends BaseStudentIT {
    ...
    public void testEqForEnum() {
        ...
        Assert.assertEquals(count, studentRepository2.count(search));
    }
    ...
    public void testNotEqForEnum() {
        ...
        Searchable search = Searchable.newSearchable(searchParams);
        Assert.assertEquals(0, studentRepository2.count(search));
    }
    ...
    public void testInWithSingleValue() throws ParseException {
        ...
        Searchable search = Searchable.newSearchable(searchParams);
        Assert.assertEquals(1, studentRepository2.count(search));
    }
    ...
    public void testOr() {
        ...
        Assert.assertEquals(2, studentRepository2.count(search));
    }
    ...
    public void testAndOr() {
        ...
        Assert.assertEquals(6, studentRepository2.count(search));
    }
