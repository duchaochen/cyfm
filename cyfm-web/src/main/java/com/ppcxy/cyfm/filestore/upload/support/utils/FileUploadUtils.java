...
public class FileUploadUtils {
    ...
    public static final String upload(
        ...
        File desc = getAbsoluteFile(extractUploadDir(request, false), filename);
    ...
    public static final String extractFilename(MultipartFile file, String baseDir, boolean needDatePathAndRandomName) {
        ...
        return cleanFileNameSpecialChar(filename.replaceAll("\\\\", "/"));
    }
    
    public static String cleanFileNameSpecialChar(String fileName) {
     ...
     * @return
     */
    public static final String extractUploadDir(HttpServletRequest request, boolean isRealPath) {
        return isRealPath ? request.getServletContext().getRealPath("/") : "/";
    }
