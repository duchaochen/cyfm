...
<body>
    <div class="easyui-layout" style="visibility: hidden;height:290px; border: 1px rgb(202, 196, 196) solid;
            border-radius: 5px;">
            ...
            <div class="easyui-tabs" data-options="fit:true,border:false">
                ...
                <div title="年">
                    ...
                    <div class="line">
                        ...
                        <input class="numberspinner" style="width: 90px;" data-options="min:2010,max:2099"
                               id="yearStart_0" value="2017">
                        -
                        <input class="numberspinner" style="width: 90px;" data-options="min:2011,max:2099"
