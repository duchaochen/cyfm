...
<div data-table="table" class="tabbable-line">
    ...
    <ul class="nav nav-pills">
        <li ${empty param.sort ? "class='active'" : ""}><a href="${ctx}/manage/monitor/hibernate/secondLevelCache#info">默认排序</a></li>
        <li ${param.sort eq 'hitPercent' ? "class='active'" : ""}><a href="${ctx}/manage/monitor/hibernate/secondLevelCache?sort=hitPercent#info">总命中率</a></li>
        <li ${param.sort eq 'sizeInMemory' ? "class='active'" : ""}><a href="${ctx}/manage/monitor/hibernate/secondLevelCache?sort=sizeInMemory#info">所占内存大小</a></li>
        <li ${param.sort eq 'elementCountInMemory' ? "class='active'" : ""}><a href="${ctx}/manage/monitor/hibernate/secondLevelCache?sort=elementCountInMemory#info">内存中的实体数</a></li>
    </ul>
