...
<div data-table="table" class="tabbable-line">
    ...
    <ul class="nav nav-pills">
        <li ${empty param.sort ? "class='active'" : ""}><a href="${ctx}/manage/monitor/ehcache">默认排序</a></li>
        <li ${param.sort eq 'hitPercent' ? "class='active'" : ""}><a href="${ctx}/manage/monitor/ehcache?sort=hitPercent">总命中率</a></li>
        <li ${param.sort eq 'objectCount' ? "class='active'" : ""}><a href="${ctx}/manage/monitor/ehcache?sort=objectCount">内存中对象数</a></li>
    </ul>
    ...
    <table class="table table-bordered">
        ...
        <tr class="bold info">
            <td colspan="2">
            ${cacheName}
            <a href="${ctx}/manage/monitor/ehcache/${cacheName}/details" class="btn btn-link no-padding pull-right">详细</a>
            </td>
        </tr>
