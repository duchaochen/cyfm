...
define(function () {
    ...
    function sh_highlightString(a, b) {
        ...
        var f = document.createElement("a"), g = document.createElement("span"), h = [], i = 0, j = [], k = 0, l = null,
            m = function (b, c) {
                var d = b.length;
                if (d === 0) return;
                if (!c) {
    ...
    function sh_highlightElement(a, b) {
        ...
        var c = [], d = sh_extractTags(a, c), e = sh_highlightString(d, b), f = sh_mergeTags(c, e),
            g = sh_insertTags(f, d);
    ...
    function sh_highlightDocument(a, b) {
        ...
        for (var d = 0; d < c.length; d++) {
            ...
            for (var g = 0; g < f.length; g++) {
                ...
                if (h.substr(0, 3) === "sh_") {
                    var i = h.substring(3);
                    if (i in sh_languages) sh_highlightElement(e, sh_languages[i]); else if (typeof a == "string" && typeof b == "string") sh_load(i, e, a, b); else throw'Found <code> element with class="' + h + '", but no such language exists';
                    break
                }
            }
        }
